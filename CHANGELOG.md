...
- Notebook, source, chat, artifact, research, sharing, and settings APIs.
- Typed artifact generation option models.
- Retry policy with backoff+jitter across RPC/query/download.
